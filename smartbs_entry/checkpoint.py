...
def checkpoint_spec_fields(engine_name: str = "entry") -> dict[str, Any]:
...
def validate_checkpoint_config(
    ...
    *,
    ...
    try:
        engine_name = normalize_feature_engine(ckpt_cfg.get(ENGINE_KEY) or "entry")
        eng = get_engine(engine_name)
...
def _assert_feature_spec_current(cfg_dict: dict, checkpoint_path: str) -> None:
    ...
    engine = normalize_feature_engine(cfg_dict.get("feature_engine") or "entry")
